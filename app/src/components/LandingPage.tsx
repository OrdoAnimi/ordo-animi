...
export function LandingPage({ onViewScenarios }: Props) {
  ...
  return (
    <div className="exec-site">
      ...
      <footer className="exec-shell exec-footer"><div className="exec-brand">VALOUR™<small>by Ordo Animi</small></div><div>Leadership preparation · ZenCloud Global Consultants</div></footer>
    </div>
  );
}
