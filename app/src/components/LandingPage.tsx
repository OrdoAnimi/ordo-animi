...
export function LandingPage({ onViewScenarios }: Props) {
  ...
  return (
    <div className="exec-site">
      ...
      <footer className="exec-shell exec-footer"><div className="exec-brand">Valourâ¢<small>by Ordo Animi</small></div><div>Leadership preparation Â· The OrdoAnimi Group</div></footer>
    </div>
  );
}
